...
define([
    ...
    var AssetsView = Backbone.View.extend({
        ...
        removeErrorClass: function() {
            $('#asset_name').parent().removeClass('has-error');
            $('#asset_description').parent().removeClass('has-error');
            $('#asset_type').parent().removeClass('has-error');
            $('#serial_number').parent().removeClass('has-error');
